      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-intenza-500/50 transition-all"
                />
              </div>
            ...
            >
              {loading ? <Loader2 size={20} className="animate-spin" /> : <>登入系統 <ChevronRight size={18} /></>}
            </button>
          </form>

          <p className="text-center text-slate-600 text-[10px] mt-12 italic">
            使用預設 Admin 帳號進行系統初始化。
          </p>
        </div>
      </div>
    </div>
